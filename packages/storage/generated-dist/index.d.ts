...
export declare function audit(action: string, target?: string, metadata?: Record<string, unknown>, actor?: string): void;
export declare function appendLog(level: "info" | "warn" | "error", message: string, metadata?: Record<string, unknown>): void;
